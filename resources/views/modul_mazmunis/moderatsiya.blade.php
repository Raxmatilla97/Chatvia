...
@section('content')
    <ol class="breadcrumb">
        <li class="breadcrumb-item">Modul mazmuni uchun</li>
    </ol>
                 ...
                 <div class="col-lg-12">
                     <div class="card">
                         <div class="card-header">
                             ...
                             Moderatsiya uchun yuborilgan resurslar ro'yxati
                         ...
                         <div class="card-body">
                            ...
                            @else
                                <div style="width: 50%; margin: auto;">
                                    ...
                                    <h2 class="text-center p-5" style="margin-top: 20px;">Moderatsiyaga yuborilgan resurslar mavjud emas!</h2>
                                </div>                                
                            @endif
                        </div>
                     </div>
